...
function _supportsColor(
  haveStream: any,
  { streamIsTTY = false, sniffFlags = true } = {},
) {
...
function assembleStyles() {
  ...
  Object.defineProperties(styles, {
    ...
    rgbToAnsi: {
      // @ts-expect-error
      value: (red: any, green: any, blue: any) =>
...
const applyOptions = (
  object: { (...strings: any[]): string; level?: any },
  ...
  const colorLevel = stdoutColor
    ? (stdoutColor as unknown as { level: boolean }).level
    : 0;
...
const createStyler = (
  open: any,
  close: any,
  parent: { openAll: any; closeAll: any } | undefined,
) => {
  let openAll;
  let closeAll;
  if (parent === undefined) {
...
const createBuilder = (
  self: any,
  _styler: { open: any; close: any; openAll: any; closeAll: any; parent: any },
  _isEmpty: boolean,
) => {
  // Single argument is hot path, implicit coercion is faster than anything
  // eslint-disable-next-line no-implicit-coercion
  const builder = (...arguments_: string[]) =>
    applyStyle(
      builder,
...
const applyStyle = (
  self: {
    (...arguments_: any[]): any;
    [x: string]: any;
    "__@GENERATOR@162242"?: any;
    "__@STYLER@162087"?: any;
    "__@IS_EMPTY@162243"?: any;
    level?: any;
  },
  string: string | string[],
) => {
...
export const chalkStderr = createChalk({
  level: stderrColor ? (stderrColor as { level?: number }).level : 0,
});
