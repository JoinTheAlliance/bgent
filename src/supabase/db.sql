...
CREATE TRIGGER trigger_create_friendship_with_host_agent AFTER INSERT ON public.accounts FOR EACH ROW EXECUTE FUNCTION public.create_friendship_with_host_agent();
...
GRANT ALL ON FUNCTION "public"."check_similarity_and_insert"(query_table_name text, query_user_id uuid, query_user_ids uuid[], query_content jsonb, query_room_id uuid, query_embedding extensions.vector, similarity_threshold double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."check_similarity_and_insert"(query_table_name text, query_user_id uuid, query_user_ids uuid[], query_content jsonb, query_room_id uuid, query_embedding extensions.vector, similarity_threshold double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_similarity_and_insert"(query_table_name text, query_user_id uuid, query_user_ids uuid[], query_content jsonb, query_room_id uuid, query_embedding extensions.vector, similarity_threshold double precision) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."search_memories"(query_table_name text, query_user_ids uuid[], query_embedding extensions.vector, query_match_threshold double precision, query_match_count integer, query_unique boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."search_memories"(query_table_name text, query_user_ids uuid[], query_embedding extensions.vector, query_match_threshold double precision, query_match_count integer, query_unique boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_memories"(query_table_name text, query_user_ids uuid[], query_embedding extensions.vector, query_match_threshold double precision, query_match_count integer, query_unique boolean) TO "service_role";

GRANT ALL ON FUNCTION "public"."search_messages"(query_embedding extensions.vector, similarity_threshold double precision, match_count integer, owner_id uuid, chat_id uuid) TO "anon";
GRANT ALL ON FUNCTION "public"."search_messages"(query_embedding extensions.vector, similarity_threshold double precision, match_count integer, owner_id uuid, chat_id uuid) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_messages"(query_embedding extensions.vector, similarity_threshold double precision, match_count integer, owner_id uuid, chat_id uuid) TO "service_role";
